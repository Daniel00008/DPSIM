...
class Classifier_modified(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck: Optional[nn.Module] = None,
        ...
        super(Classifier_modified, self).__init__()
...
class ImageClassifier_modified(Classifier_modified):
    def __init__(self, backbone: nn.Module, num_classes: int, bottleneck_dim: Optional[int] = 256, **kwargs):
        ...
        super(ImageClassifier_modified, self).__init__(backbone, num_classes, bottleneck, bottleneck_dim, **kwargs)