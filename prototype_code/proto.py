...
from examples.domain_adaptation.image_classification.prototype_code.utils import pairwise_distances
...
def proto_net_episode(model: Module,
    ...
    prototypes = compute_prototypes(support, k_way, n_shot)  # torch.Size([31, 256])
